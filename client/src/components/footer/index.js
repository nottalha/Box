                        ...
                        <div className="col col-lg-3 offset-lg-1 col-md-6 col-sm-12 col-12">
                            <div className="widget market-widget tp-service-link-widget">
                                ...
                                <div className="contact-ft">
                                    <ul>
                                        <li><i className="fi flaticon-pin"></i>karachi, Pakistan</li>
                                        <li><i className="fi flaticon-call"></i>+9234385105</li>
                                        <li><i className="fi flaticon-envelope"></i>go2trust@gmail.com</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col col-xs-12">
                            <p className="copyright">&copy; 2021 go2trust. All rights reserved</p>
                        </div>
                    </div>
                </div>
            </div>
